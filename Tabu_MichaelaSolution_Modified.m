...
lengthH = 10; %Initialize and create list of steps
...
for m=1:5
    test(m)=0.96*(m-1);
    bestSolution = a+test(m); %Create inital solution and calculate inital solution fitness
    ...
    display(overallBest)
    display(overallBestFitness)
end
plot(overallBest, overallBestFitness, 'Xg') %Show the best solution
